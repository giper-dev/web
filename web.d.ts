...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"image" | "line" | "text" | "current" | "hue" | "back" | "hover" | "card" | "special" | "control" | "shade" | "focus" | "field" | "spirit" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
	...
	type $giper_web_bar_link__icon_giper_web_bar_15 = $mol_type_enforce<
		...
		ReturnType< $giper_web_bar_link['icon'] >
	>
	type $mol_link_source__uri_giper_web_bar_16 = $mol_type_enforce<
		string
		,
